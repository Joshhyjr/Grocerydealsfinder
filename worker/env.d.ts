/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/env.d.ts` (hash: edb7921966498bfa7c65717cdd4e7856)
// Runtime types generated with workerd@1.20260616.1 2026-06-18 nodejs_compat
interface __BaseEnv_Env {
	PRICE_SNAPSHOTS: KVNamespace;
	ALLOWED_ORIGINS: "https://joshhyjr.github.io,http://127.0.0.1:5173,http://localhost:5173";
	DEFAULT_REGION: "halifax-metro";
	PROVIDER_FEED_URLS: "";
...
interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "DEFAULT_REGION" | "PROVIDER_FEED_URLS" | "OPEN_PRICES_RADIUS_KM" | "SNAPSHOT_MAX_AGE_SECONDS">> {}
}
